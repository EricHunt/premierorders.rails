...
ActiveRecord::Schema.define(:version => 20111011074541) do
  ...
  create_table "franchisees", :force => true do |t|
    ...
    t.text     "notes"
    t.integer  "customer_category",                                              :default => 0, :null => false
  end

  create_table "group_item_categories", :force => true do |t|
